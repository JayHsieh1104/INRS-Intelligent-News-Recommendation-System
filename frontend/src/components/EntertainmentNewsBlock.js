...
import './EntertainmentNewsBlock.css';
const config = require("../../config.json");

class EntertainmentNewsBlock extends React.Component {
    constructor(props) {
        super();
        this.state = {
          _error: null,
      ...
      render() {
        ...
        if (_error) {
          ...
          return (
            <div>
              <div className="BlockTitle">Entertainment News</div>
...
export default EntertainmentNewsBlock;